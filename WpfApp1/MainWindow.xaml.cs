...
namespace WpfApp1
{
    public partial class MainWindow : Window
    {
        ...
        private void Generavimas_Checked(object sender, RoutedEventArgs e)
        {
            string password = Password.Generate(20);
            Console.WriteLine("{0}", password);
            Uzkodavimo_tekstas.Text = password;
        }

        private void Atkodavimo_tekstas_TextChanged(object sender, System.Windows.Controls.TextChangedEventArgs e)
        {
